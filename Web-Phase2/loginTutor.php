...
if(isset($_POST['submit'])){
 ...
 $query = "SELECT * FROM tutor WHERE Email='$uemail' AND password ='$upassword'";
...
echo '<script>alert("invalid email or password");window.location.href="loginTutor.php";</script>';
